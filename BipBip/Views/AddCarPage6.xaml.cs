...
namespace BipBip.Views
{
    public partial class AddCarPage6 : ContentPage
    {
        ...
        private async void OnFinishButtonClicked(object sender, EventArgs e)
        {
            ...
            Console.WriteLine("$$$$$$$$$$$$$$$$$$$$$$$$$ : " + UserSession.Id);
           
            System.Diagnostics.Debug.WriteLine(" nummImmc: " + _vehicule.Owner + " " + " type: " + _vehicule.Type + " " + " marque: " + _vehicule.Marque + " " + " Modele: " + _vehicule.Modele + " " + " couleur: " + _vehicule.Couleur + " " + " annee: " + _vehicule.AnneeImmatriculation + " ");
